module type LANG = sig
  ...
  val subst_names_of_nup : interactive_env -> nup -> computation
  val compute_nf : opconf -> opconf option
  val decompose_nf : opconf -> name * glue_val
  val val_composition : interactive_val -> computation -> computation

  val abstract_glue_val :
    glue_val -> interactive_type -> nup * interactive_env * name_type_ctx
