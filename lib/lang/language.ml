module type LANG = sig
  ...
  val get_typed_ienv :
    in_channel -> in_channel -> interactive_env * resources * name_type_ctx * name_type_ctx
  ...
  val generate_nup :
    name_type_ctx -> interactive_type -> (nup * name_type_ctx) list
  ...
  val abstract_ival :
    interactive_val -> interactive_type -> nup * interactive_env * name_type_ctx
