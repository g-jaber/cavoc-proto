The reference scenario is test/no-visible-flag/no-visible-flag.ml: g calls its argument f
...
the second call to f.
  ...
  $ printf 'no\n1\nno\n3\nno\nexit\n' | cavoc-explore_cli no-visible-flag/no-visible-flag.ml no-visible-flag/no-visible-flag.mli | tail -7
...
CPS, with visibility: f1 is filtered out.
  ...
  $ printf 'no\n1\nno\n3\nno\nexit\n' | cavoc-explore_cli -vis no-visible-flag/no-visible-flag.ml no-visible-flag/no-visible-flag.mli | tail -6
  (yes/no/exit) The possible moves are:
  1: g(f1,c1)
  2: f2((),c1)
  3: c1(())
...
Direct style, without visibility.
  ...
  $ printf 'no\n1\nno\n3\nno\nexit\n' | cavoc-explore_cli -no-cps no-visible-flag/no-visible-flag.ml no-visible-flag/no-visible-flag.mli | tail -7
  (yes/no/exit) The possible moves are:
  1: g(f1)
  2: f1(())
  3: f2(())
...
Direct style, with visibility: f1 is filtered out.
  ...
  $ printf 'no\n1\nno\n3\nno\nexit\n' | cavoc-explore_cli -no-cps -vis no-visible-flag/no-visible-flag.ml no-visible-flag/no-visible-flag.mli | tail -6
  (yes/no/exit) The possible moves are:
  1: g(f1)
  2: f2(())
  3: ret(())
...
toplevel answer, which must restore the initial view.
  ...
  $ printf 'no\n1\nno\nexit\n' | cavoc-explore_cli -no-cps -vis -program while/while.ml | tail -8
